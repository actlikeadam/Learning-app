<template>
<!-- @close is the event we are emitting from BaseDialog -->
<base-dialog v-if="inputIsInvalid" title="Invalid Input" @close="confirmError">
  <template #default>
    <p>At least one input is invalid</p>
    <p>Please, fill all the empty spaces</p>
  </template>
  <template #actions>
  ...
  <base-card>
    <form @submit.prevent="submitData">
      ...
      <div class="form-control">
        ...
        <textarea id="description" name="descriprion" rows="3" ref="descriptionInput"></textarea>
      </div>
      <div class="form-control">
